...
awful.spawn.with_shell(
    ...
    'dex -a -e Awesome\'' -- https://github.com/jceb/dex
)
awful.spawn.with_shell('bash -c \'dbus-update-activation-environment --all\'')
...
awful.util.tagnames = { "1", "2", "3", "4", "Spotify" }
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "Music"}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    -- General
    awful.key({ altkey, "Control" }, "s", function () awful.util.spawn("systemctl suspend") end),
    -- Music
